...
<h1 className=" tracking-tight text-balance text-white text-[48px] ">
              <span className=" font-bold block">Uncover Complete</span>
              <span className="block text-white">
            ...
            <p className=" text-pretty text-white  text-md max-w-3xl mx-auto leading-relaxed text-lg">
